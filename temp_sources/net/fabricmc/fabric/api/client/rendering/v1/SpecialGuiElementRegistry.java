 ...
 * When you want to render, add an instance of the corresponding render state to {@link net.minecraft.client.gui.DrawContext#field_59826 DrawContext#state} using {@link net.minecraft.client.gui.render.state.GuiRenderState#addSpecialElement(net.minecraft.client.gui.render.state.special.SpecialGuiElementRenderState)}  GuiRenderState#addSpecialElement(SpecialGuiElementRenderState)}.
 */
